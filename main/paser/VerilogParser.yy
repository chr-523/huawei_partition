...
general_name_array: NAME {
        ...
        | BIT_MASK {
          $$ = new GeneralNameArray(1, GeneralName($1.value));
        }
        | NAME range {
        ...
        | general_name_array ',' BIT_MASK {
            $1->push_back(GeneralName($3.value));
            $$ = $1;
        }
        | general_name_array ',' NAME {
...
param5: WIRE general_name_array {driver.wire_declare_cbk(*$2); delete $2;}
      ...
      | TRI  general_name_array {driver.wire_declare_cbk(*$2); delete $2;}
      | TRI  range general_name_array {driver.wire_declare_cbk(*$3, *$2); delete $2; delete $3;}
      ;
...
module_instance: NAME NAME '(' instance_params ')' ';' {driver.module_instance_cbk(*$1, *$2); delete $1; delete $2;}
               ...
               ;
assignment: ASSIGN NAME '=' BIT_MASK ';' {driver.assignment_cbk(*$2, Range(), $4.bits, $4.value); delete $2; }
          | ASSIGN NAME range '=' BIT_MASK ';' {driver.assignment_cbk(*$2, *$3, $5.bits, $5.value); delete $2; delete $3; }
          | ASSIGN NAME '=' NAME ';' {driver.assignment_cbk(*$2, Range(), *$4, Range()); delete $2; delete $4;}
...
single_module: module_declare module_content ENDMODULE 
             ;
modules:  single_module {driver.modules_cbk();}
        | modules single_module {driver.modules_cbk();}
        ;
